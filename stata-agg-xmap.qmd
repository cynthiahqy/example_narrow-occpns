...
The first step is creating the a "carbon paper" object that stands in for original data:
...
```{r}
#| file: 03-extract-xmap-from-dta.R
#| filename: "03-extract-xmap-from-dta.R"
#| eval: false
```
